...
| Requirement ID | Requirement | Source Artifact | Acceptance Criteria | Functional Coverage | Technical Coverage | Test Coverage | Status |
|---|---|---|---|---|---|---|---|
| REQ-001 |  | user-story.md | AC-001 | functional-spec.md | technical-spec.md | test-plan.md | Pending |
