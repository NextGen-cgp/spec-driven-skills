...
|---|---|---|
| Admin | Manage quality plans and parameters | Can create, edit and search. |
...
| FR-006 | The system must allow both Admin and Analyst users to search for quality plans. | MUST | request.md |
...
|---|---|---|
| Permissions enforced only in frontend | Analysts could bypass restrictions. | Requires backend authorization review. |
