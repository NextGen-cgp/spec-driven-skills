# Technical Validation Rules: <feature-id>
...
| Operation | Required permission | Backend enforcement | Frontend behavior |
|---|---|---|---|
| `<operation>` | `<permission>` | `<yes/no>` | `<visible/hidden/disabled>` |
